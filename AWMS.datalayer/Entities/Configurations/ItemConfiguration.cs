...
namespace AWMS.datalayer.Entities.Configurations
{
    public class ItemConfiguration : IEntityTypeConfiguration<Item>
    {
        public void Configure(EntityTypeBuilder<Item> builder)
        {
            ...
            builder.Property(i => i.OverQty)
                .HasColumnType("decimal(18,2)");

            builder.Property(i => i.ShortageQty)
                .HasColumnType("decimal(18,2)");

            builder.Property(i => i.DamageQty)
                .HasColumnType("decimal(18,2)");

            builder.Property(i => i.IncorectQty)
                .HasColumnType("decimal(18,2)");

            builder.Property(i => i.Price)
                .HasColumnType("decimal(18,2)");

            builder.Property(i => i.NetW)
                .HasColumnType("decimal(18,2)");

            builder.Property(i => i.GrossW)
                .HasColumnType("decimal(18,2)");

            builder.Property(i => i.NIS)
                .HasColumnType("decimal(18,2)");
            ...
            builder.Property(i => i.MTRNo)
                .HasMaxLength(200);

            builder.Property(i => i.ColorCode)
                .HasMaxLength(50);

            builder.Property(i => i.LabelNo)
                .HasMaxLength(50);

            builder.Property(i => i.StorageCode)
                .HasMaxLength(50);
            ...
            // ایجاد ایندکس بر روی فیلد Tag
            builder.HasIndex(i => i.Tag).HasDatabaseName("IX_Item_Tag");

            // ایجاد ایندکس بر روی فیلد Description
