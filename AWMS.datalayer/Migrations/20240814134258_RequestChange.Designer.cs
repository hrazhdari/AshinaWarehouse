...
namespace AWMS.datalayer.Migrations
{
    ...
    [Migration("20240814134258_RequestChange")]
    partial class RequestChange
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnteredDate = new DateTime(2024, 8, 14, 18, 12, 58, 385, DateTimeKind.Local).AddTicks(2476)
                        },
                        new
                        {
                            CompanyID = 2,
                            Abbreviation = "TESCO",
                            CompanyName = "Teco",
                            EnteredDate = new DateTime(2024, 8, 14, 18, 12, 58, 385, DateTimeKind.Local).AddTicks(2494)
                        });
                });
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationID = 1,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 8, 14, 18, 12, 58, 384, DateTimeKind.Local).AddTicks(2475),
                        ...
                        new
                        {
                            LocationID = 2,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 8, 14, 18, 12, 58, 384, DateTimeKind.Local).AddTicks(2539),
                        ...
                        new
                        {
                            LocationID = 3,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 8, 14, 18, 12, 58, 384, DateTimeKind.Local).AddTicks(2542),
