...
namespace AWMS.datalayer.Migrations
{
    ...
    [Migration("20240731102239_changePackingList")]
    partial class changePackingList
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnteredDate = new DateTime(2024, 7, 31, 14, 52, 39, 4, DateTimeKind.Local).AddTicks(657)
                        },
                        new
                        {
                            CompanyID = 2,
                            Abbreviation = "TESCO",
                            CompanyName = "Teco",
                            EnteredDate = new DateTime(2024, 7, 31, 14, 52, 39, 4, DateTimeKind.Local).AddTicks(668)
                        });
                });
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationID = 1,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 7, 31, 14, 52, 39, 3, DateTimeKind.Local).AddTicks(9396),
                        ...
                        new
                        {
                            LocationID = 2,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 7, 31, 14, 52, 39, 3, DateTimeKind.Local).AddTicks(9446),
                        ...
                        new
                        {
                            LocationID = 3,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 7, 31, 14, 52, 39, 3, DateTimeKind.Local).AddTicks(9448),
